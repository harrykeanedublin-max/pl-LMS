...
import EditAliasesForm from "@/components/admin/EditAliasesForm";
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sub text-sm">
          ...
          looked up automatically from Wikipedia when a team is added. Aliases let bulk fixture
          entry match nicknames like &quot;Spurs&quot; or &quot;Man City&quot;, not just the full
          name or short code.
        </p>
      </div>
        ...
        <tbody>
          {teams.map((t) => (
            <tr key={t.id} className="border-b border-dashed border-line">
              ...
              <td className="py-2 pr-4">
                <EditAliasesForm teamId={t.id} aliases={t.aliases} />
              </td>
